...
namespace NexusWeb.Controllers
{
	...
	public class DistributorsController : Controller
    {
        ...
        public DistributorsController(NexusWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phone")] Distributor distributor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phone")] Distributor distributor)
        {
